...
def api2():
	...
	print(f"\033[1;91m {phone} SEND OTP sso")
...
def api5():
	...
	print(f"\033[1;94m {phone} SEND OTP joox")
...
def api6():
	...
	print(f"\033[1;95m {phone} SEND OTP pizza1112")
...
def api7():
	...
	print(f"\033[1;96m {phone} SEND OTP makroclick")
...
def api11():
	...
	print(f"\033[1;92m {phone} SEND OTP zaapi")
...
def api14():
	...
	print(f"\033[1;95m {phone} SEND OTP theconcert")
...
if (500 < 501):
	...
	print("\033[1;91m จำนวนไม่เกิน 1 ล้านค่ะ") # จำนวนไม่เกิน500 กำหนดตรง if ใส่501คือใส่จำนวนเกิน500ไม่ได้
	time.sleep(1)
	os.system("FLUK.py") # ใส่ชื่อไฟล์ของเราเพื่อให้มันเริ่มใหม่
